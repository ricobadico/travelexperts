...
--
CREATE DATABASE IF NOT EXISTS `travelexpertsGroup1` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `travelexpertsGroup1`;
...
(1, 'Caribbean New Year', '2021-12-25 00:00:00', '2021-01-04 00:00:00', 'Cruise the Caribbean & Celebrate the New Year.', '4800.0000', '400.0000'),
(2, 'Polynesian Paradise', '2021-12-12 00:00:00', '2021-12-20 00:00:00', '8 Day All Inclusive Hawaiian Vacation', '3000.0000', '310.0000'),
(3, 'Asian Expedition', '2021-05-14 00:00:00', '2021-05-28 00:00:00', 'Airfaire, Hotel and Eco Tour.', '2800.0000', '300.0000'),
(4, 'European Vacation', '2021-11-01 00:00:00', '2021-11-14 00:00:00', 'Euro Tour with Rail Pass and Travel Insurance', '3000.0000', '280.0000');
...
--
-- Data for the current customers
-- this will not add to users added after travelexperts.sql import
-- everyone has the default password `password`
-- only users with emails are set to active
-- usernames default firsrnames but they don't have to match `customers` table
--

INSERT INTO `web_credentials` (`CustomerId`, `Username`, `Hash`, `Active`) VALUES
(104, 'Laetia', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(105, 'Angel',  '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(106, 'Judith', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(107, 'Catherine', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(108, 'Judy',   '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(109, 'Larry',  '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(114, 'Winsome', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(117, 'Nancy',  '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(118, 'Hiedi',  '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(119, 'Mardig', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(120, 'Ralph',  '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(121, 'Sean',   '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(122, 'Julita', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(123, 'Pierre', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(127, 'Gary',   '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(128, 'Jeff',   '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(130, 'Lula',   '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(133, 'James',  '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(135, 'Michellexxxxxxxxxxxxxx', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(138, 'John',   '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(139, 'Angelo', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(140, 'Derrick', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(141, 'Robert', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(142, 'Monica', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', TRUE),
(143, 'Gerard', '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE),
(144, 'z',      '$2b$10$xpW2q/66FpNC6TjGDp3onehApNj5iiNwC/9s9vHsaWmKcxi470TpOL', FALSE);


INSERT INTO `packages` (`PackageId`, `PkgName`, `PkgStartDate`, `PkgEndDate`, `PkgDesc`, `PkgBasePrice`, `PkgAgencyCommission`) VALUES 
(NULL, 'Masai Mara Safari', '2021-06-18 12:51:52', '2021-06-25 12:51:52', "Explore Kenya\'s incredible views and wildlife", '3300', '330'),
(NULL, 'Wonderous Iceland', '2021-02-11 12:51:52', '2021-02-18 12:51:52', 'A week of ice, folklore and magic', '2800', '280');

ALTER TABLE `web_credentials`
  ADD PRIMARY KEY (`Username`);

ALTER TABLE `web_credentials`
  ADD CONSTRAINT `web_credentials_ibfk_1` FOREIGN KEY (`CustomerId`) REFERENCES `customers` (`CustomerId`);
